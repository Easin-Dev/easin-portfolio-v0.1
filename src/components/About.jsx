...
import { Sparkles, Users, Code, Shield, ArrowUpRight, Zap } from 'lucide-react';
...
const INITIAL_ABOUT_DATA = {
    ...
    approachText1: "With <span class='text-blue-600 font-bold'>3 years</span> of focused, high-impact development, I've cultivated a deep technical foundation. I specialize in turning complex challenges into robust, production-ready systems.",
    approachText2: "My expertise centers around the <span class='text-blue-600 font-bold'>MERN stack</span> (MongoDB, Express, React, Node.js), leveraged to architect high-performance, scalable applications with minimal technical debt.",
    partnerTitle: "CEO & Founder: Guiding Scaleup Web's Vision",
    strategyPoint: "<strong>Strategic Leadership:</strong> Beyond development, I provide C-level guidance to align digital strategy with business goals, maximizing client <strong>Return on Investment (ROI)</strong>.",
    reliabilityPoint: "<strong>Architectural Resilience:</strong> I leverage technical and entrepreneurial insight to build platforms that are scalable, secure, and future-proof.",
};

const AboutSection = ({ id }) => {
    const [aboutData] = useState(INITIAL_ABOUT_DATA);

    // লিকুইড গ্লাস ইফেক্ট ক্লাস
    const glassCardClasses = "backdrop-blur-xl bg-white/40 border border-white/60 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] transition-all duration-500 hover:bg-white/60 hover:shadow-2xl hover:-translate-y-1";
    ...
    return (
        <section id={id} className="py-24 sm:py-32 overflow-hidden relative bg-white">
            ...
            <div className="absolute top-0 left-0 w-full h-[600px] z-0" style={meshGradientBackground} />
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="mx-auto max-w-3xl lg:text-center mb-20">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 border border-gray-200 shadow-sm backdrop-blur-md mb-6 animate-fade-in">
                        ...
                        <span className="text-xs font-bold tracking-widest text-gray-800 uppercase">Our Core Identity</span>
                    </div>
                ...
                <div className="grid gap-16 lg:grid-cols-2 items-start">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative rounded-[2rem] overflow-hidden border-8 border-white shadow-2xl transform transition duration-700 group-hover:scale-[1.01]">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 backdrop-blur-md bg-white/80 p-4 rounded-2xl border border-white/50 shadow-lg">
                                <p className="text-blue-600 font-black text-xs uppercase tracking-widest mb-1">{aboutData.badgeText}</p>
                                <div className="flex items-center justify-between">
                                    <span className="text-gray-900 font-bold italic">Easin Arafat</span>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="space-y-6 text-gray-600 mb-12">
                            <p className="text-xl font-medium leading-relaxed" dangerouslySetInnerHTML={{ __html: aboutData.approachText1 }} />
                            <p className="text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: aboutData.approachText2 }} />
                        </div>
                            ...
                            <div className="grid gap-4">
                                ...
                                <div className={`group p-6 rounded-3xl ${glassCardClasses}`}>
                                    <div className="flex items-start gap-4">
                                        ...
                                        <p className="text-base text-gray-700 leading-relaxed pt-1" dangerouslySetInnerHTML={{ __html: aboutData.strategyPoint }} />
                                    </div>
                                </div>
                                ...
                                <div className={`group p-6 rounded-3xl ${glassCardClasses}`}>
                                    <div className="flex items-start gap-4">
                                        ...
                                        <p className="text-base text-gray-700 leading-relaxed pt-1" dangerouslySetInnerHTML={{ __html: aboutData.reliabilityPoint }} />
                                    </div>
                                </div>
                            </div>
                        </div>
