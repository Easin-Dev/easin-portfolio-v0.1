...
const CONTACT_INFO = [
    { icon: Mail, label: 'Email Address', value: 'mdeasinarafat016456@gmail.com', link: 'mailto:mdeasinarafat016456@gmail.com' },
    { icon: Phone, label: 'Phone Number', value: '+8801645650504', link: 'tel:+8801645650504' },
    { icon: MapPin, label: 'Office Address', value: 'Tejkunipara, Farmgate, Dhaka', link: '#' },
];
...
const ContactSection = () => {
    // ফর্মের স্টেট হ্যান্ডেল করার জন্য
    ...
    const handleSubmit = (e) => {
        ...
        // এখানে আপনি ডাটা পাঠানোর লজিক যোগ করতে পারেন
    };
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-start">
                    <div className="lg:col-span-5 space-y-8">
                                ...
                                {CONTACT_INFO.map((item, i) => (
                                    <a key={i} href={item.link} className="flex items-center gap-5 group">
                                        ...
                                        <div className="overflow-hidden">
                                            ...
                                            <p className="text-gray-900 font-bold group-hover:text-blue-600 transition-colors break-all">{item.value}</p>
                                        </div>
                                    </a>
                                ))}
                            </div>
                        ...
                        <div className="p-8 rounded-[2rem] bg-white/20 backdrop-blur-md border border-white/40">
                            <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-6 text-center lg:text-left px-2">Professional Network</p>
                            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                                {SOCIAL_LINKS.map((social, i) => (
                                    <a key={i} href={social.link} target="_blank" rel="noopener noreferrer" className={`w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center text-gray-600 ${social.color} hover:text-white transition-all duration-500 hover:-translate-y-2`}>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full bg-transparent border-b-2 border-gray-200 py-3 focus:border-blue-600 focus:outline-none transition-colors peer font-medium text-gray-900"
                                            placeholder=" "
                                        />
                                ...
                                <div className="relative">
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        className="w-full bg-transparent border-b-2 border-gray-200 py-3 focus:border-blue-600 focus:outline-none transition-colors peer font-medium text-gray-900 resize-none"
                                        placeholder=" "
                                    ></textarea>
                                ...
                                <button type="submit" className="w-full group relative inline-flex items-center justify-center px-10 py-5 text-sm font-black uppercase tracking-widest text-white overflow-hidden rounded-2xl bg-gray-900 transition-all duration-300">
